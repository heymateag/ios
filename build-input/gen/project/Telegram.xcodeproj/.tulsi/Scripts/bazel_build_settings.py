...
BUILD_SETTINGS = BazelBuildSettings(
    '/Users/apple/Documents/GitHub/Telegram-iOS_jan1/build-input/gen/project/bazel',
    '/private/var/tmp/_bazel_apple/6798e912aded6095d560f2053adedc60/execroot/__main__',
    '/private/var/tmp/_bazel_apple/6798e912aded6095d560f2053adedc60',
    'ios_x86_64',
    {
        'ios_x86_64': [
    ...
    BazelFlagsSet(
        debug = BazelFlags(
            startup = [],
            build = [
                '--override_repository=tulsi=/Users/apple/Library/Application Support/Tulsi/0.20210318.88/Bazel',
    ...
    BazelFlagsSet(
        flags = BazelFlags(
            startup = [],
            build = [
                '--override_repository=build_configuration=/Users/apple/telegram-configuration',
                ...
                '--define=telegramVersion=8.4',
                '--disk_cache=/Users/apple/telegram-bazel-cache',
                '--//Telegram:disableExtensions',
            ],
        ),
    ),
